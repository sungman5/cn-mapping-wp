...
export default function Header() {
  ...
  return (
    <header className="flex items-center justify-between px-6 py-4 bg-white border-b xl:h-24 xl:px-11">
      ...
      <Image className="hidden xl:block" src={"/cn-brand-logo.svg"} width={214} height={48} alt="청소년활동진흥원 브랜드이미지"></Image>
    </header>
  );
}
